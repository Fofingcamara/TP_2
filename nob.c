...
int main(int argc, char** argv) {
  ...
  nob_cc_inputs(&cmd, "./src/main.cpp", "./src/entrypoint.cpp", "./src/Soucoupe.cpp", "./src/Jeu.cpp", "./src/Vaisseau.cpp", "./src/GameObject.cpp", "./src/Menu.cpp", "./src/Projectile.cpp", "./src/Asteroide.cpp");
